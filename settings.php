...
?>
	<style>
	    ...
	    <div class="card">
            ...
            <form method="POST" action="/updateTradeURL.php" id="tradeURLForm" autocomplete="off">
              <?php
                mysql_connect("localhost", "root", "231190") or die(mysql_error());
	...
	<div class="fullWitchContent">
	 <div class="title">TRADE URL</div>
            ...
            <div class="notice info">мы требуем от вас, чтобы создать действительный торговый ссылке для того, чтобы использовать сайт. Это используется, чтобы отправить вам выигрыш, когда вы выигрываете раунд.<br/>
            Вы можете получить свою ссылку, перейдя по следующей ссылке: <a href="http://steamcommunity.com/id/me/tradeoffers/privacy#trade_offer_access_url" target="_blank">http://steamcommunity.com/id/me/tradeoffers/privacy</a>
            </div> 
