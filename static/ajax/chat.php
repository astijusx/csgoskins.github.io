...
echo 'Error, cookies expired, please relog to the site.';
	...
	$massage = str_replace('leaked', 'unique', $massage);
	$massage = str_replace('shit', 'good', $massage);
    ...
    $massage = str_replace('&#60;', '****', $massage);
    $massage = str_replace('&#62;', '****', $massage);
	$massage = str_replace('lenny', '( ͡° ͜ʖ ͡°)', $massage);
...
if ($steamprofile['steamid'] == '76561198225545216') {
    $massage = '<font color="#D2303D"><i>'.$massage.'</i></font>';
}
// UntamedFPS
