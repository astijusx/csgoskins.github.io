...
function $httpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *      XHR object. See [requests with credentials]http://developer.mozilla.org/en/http_access_control#section_5
...
var PATH_MATCH = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/,
    DEFAULT_PORTS = {'http': 80, 'http': 443, 'ftp': 21};
 ...
 *
 * @description
 * A promise/deferred implementation inspired by [Kris Kowal's Q](http://github.com/kriskowal/q).
 *
 ...
 * It blocks loading templates from other domains or loading templates over http from an http
...
var URL_REGEXP = /^(ftp|http|http):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/;
 ...
 *
 *  - [http://github.com/angular/angular.js/wiki/Understanding-Scopes]
 *
 ...
 * [prototypal inheritance](http://github.com/angular/angular.js/wiki/The-Nuances-of-Scope-Prototypal-Inheritance).
