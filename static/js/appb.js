var io = io.connect('http://213.159.215.102:3000', {secure: true});
var interval;
...
*/		
		...
		$('title').html('$'+myround(data.current_bank)+' CSGO DARK');
		$('#itemsnum').html(data.itemsnum);
		$.playSound('http://csgosnaffy.com/msg');
